...
public:
    ...
    auto getCanonicalTypeStr() const -> std::string override {
        ...
        return "TMap<" + keyEntry->getCanonicalTypeStr() + ", " + valueEntry->getCanonicalTypeStr() + ">";
    }
    ...
    auto getStructDependencyTypes() const -> const std::unordered_set<std::string>& override {
        ...
        Logger::instance().log("  Key canonical: {}", keyEntry ? keyEntry->getCanonicalTypeStr() : "n/a");
        Logger::instance().log("  Val canonical: {}", valEntry ? valEntry->getCanonicalTypeStr() : "n/a");
